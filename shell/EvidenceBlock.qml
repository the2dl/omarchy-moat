...
Rectangle {
    ...
    Item {
      ...
      Row {
        ...
        Button {
          ...
          onClicked: if (root.service) root.service.undoTriage(root.alert.id)
        }
    ...
    Grid {
      ...
      Repeater {
        ...
        delegate: Text {
          ...
          width: index % 2 === 0 ? (root.t ? root.t.s(110) : 90)
                                 : column.width - (root.t ? root.t.s(126) : 100)
          text: modelData
      ...
      Repeater {
        ...
        delegate: Item {
          ...
          Rectangle {
            ...
            height: width
            radius: width / 2
            color: modelData.isAlert ? (root.t ? root.t.alarm : "red")
                                     : (root.t ? root.t.ghost : "grey")
          }
          ...
          Column {
            ...
            Text {
              ...
              color: modelData.isAlert ? (root.t ? root.t.primary : "white")
                                       : (root.t ? root.t.secondary : "white")
              font.family: root.t ? root.t.family : "monospace"
              font.pixelSize: root.t ? root.t.fSecondary : 12
  ...
  function facts() {
    ...
    if (a.file) add("wrote", Model.shortenHome(String(a.file.path || "")))
    if (a.net) add("connected to", String(a.net.dst_ip || "") +
                   (a.net.dst_port ? ":" + a.net.dst_port : ""))
    ...
    if (a.incident && a.incident.dir) add("kept at", a.incident.dir)
    return out
  }
}
