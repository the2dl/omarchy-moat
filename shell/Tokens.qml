...
QtObject {
  ...
  readonly property color primary: root.ramp(0.00)     // #f6f4f2 -- headlines, the one thing to read
  ...
  readonly property color dim: root.ramp(0.40)         // #9d9892
  ...
  readonly property color deepest: root.ramp(0.90)     // #26241f -- the rule-covered tick
  ...
  function hair(a) { return Qt.rgba(root.ink.r, root.ink.g, root.ink.b, a) }
  ...
  function labelOn(c) {
    ...
    return l > 0.5 ? Qt.rgba(0.10, 0.06, 0.02, 1) : Qt.rgba(0.98, 0.96, 0.95, 1)
  }
  readonly property color accentLabel: root.labelOn(root.accent)
  readonly property color alarmLabel: root.labelOn(root.alarm)

  function accentTint(a) { return Qt.rgba(root.accent.r, root.accent.g, root.accent.b, a) }
  function alarmTint(a) { return Qt.rgba(root.alarm.r, root.alarm.g, root.alarm.b, a) }
  function calmTint(a) { return Qt.rgba(root.calm.r, root.calm.g, root.calm.b, a) }
  ...
  function r(px) { return root.rounded ? Math.round(px * root.scale) : 0 }
  ...
  function pt(px) { return Math.round(px * root.scale) }
  ...
  readonly property real lhCode: 2.0
  ...
  function v(px) { return Math.round(px * root.scale * (root.compact ? 0.6 : 1)) }
  ...
  // ----------------------------------------------------------------- misc
  readonly property int dotSize: root.s(9)          // the verdict dot
  readonly property int tickWidth: root.s(3)        // history severity tick
