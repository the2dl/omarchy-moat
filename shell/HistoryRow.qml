...
Item {
  ...
  readonly property color tickColor: {
    ...
    switch (root.state) {
    case "needsYou": return root.t.alarm
    case "contained": return root.t.calm
    case "expected": return root.t.deepest
    default: return root.t.ghost
    }
  }
  ...
  readonly property color titleColor: {
    if (!root.t) return "white"
    switch (root.state) {
    case "needsYou": return root.t.primary
    case "expected": return root.t.faint
    default: return root.t.secondary
    }
  }
  ...
  readonly property color stateColor: {
    ...
    case "needsYou": return root.t.alarm
    case "contained": return root.t.calm
    case "expected": return root.t.ghost
    default: return root.t.faint
    }
  }
  ...
  Rectangle {
    anchors.fill: parent
    color: root.selected ? (root.t ? root.t.hair(0.05) : "transparent")
      : (mouse.containsMouse ? (root.t ? root.t.hair(0.03) : "transparent") : "transparent")
  ...
  Item {
    ...
    Text {
      ...
      width: Math.min(implicitWidth,
                      parent.width - x - age.width - stateWord.width
                      - (root.t ? root.t.s(56) : 40))
