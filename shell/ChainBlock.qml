...
Column {
    ...
    Text {
        text: {
            ...
            return day ? "WHAT HAPPENED, IN ORDER  \u00b7  " + day.toUpperCase() : "WHAT HAPPENED, IN ORDER";
        }
    ...
    Repeater {
        ...
        delegate: Item {
            ...
            Rectangle {
                ...
                height: width
                radius: width / 2
                color: modelData.isContext ? (root.t ? root.t.ghost : "grey") : (root.t ? root.t.alarm : "red")
            }
            ...
            Column {
                ...
                Text {
                    ...
                    color: modelData.isContext ? (root.t ? root.t.secondary : "white") : (root.t ? root.t.primary : "white")
                    font.family: root.t ? root.t.family : "monospace"
                ...
                // The concrete event: the program and the file it read or the
                // host it reached. The rule title says WHAT KIND of thing
                // happened; this says the actual thing, which is what a person
                // needs to decide whether it was them.
                Text {
                    width: parent.width
                    visible: text !== ""
    ...
    Text {
        ...
        text: root.chain ? "… " + Math.max(0, root.chain.steps_total - root.chain.steps.length) + " more not shown" : ""
