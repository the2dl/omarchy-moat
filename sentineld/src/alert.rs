...
pub struct ExplainOption {
    pub scope: String,
    /// Ready to paste: `sentinelctl ignore <id> --scope exe`.
    pub cmd: String,
...
pub mod tests_support {
    ...
    pub fn demo_alert(id: &str) -> Alert {
        Alert {
            ...
            severity: "high".into(),
            rule: "sentinel-cred-ssh-private-key-read".into(),
            family: "cred".into(),
            ...
            explain: Explain {
                ...
                if_expected: IfExpected {
                    ...
                    options: vec![ExplainOption {
                        scope: "exe".into(),
                        cmd: "sentinelctl ignore 01J8ZK6B4Q3M7N9P2R5S8T1V4W --scope exe".into(),
                        line: "[[rule]]\nname = \"x\"\n".into(),
                    }],
                    file: "/etc/sentinel/allowlist.d/user.toml".into(),
                },
